...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button accountRegiest = findViewById(R.id.email_register_button);
        accountRegiest.setOnClickListener(new OnClickListener() {
            @Override
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginActivity.this, "Authentication failed. Please double check your email and password.",
